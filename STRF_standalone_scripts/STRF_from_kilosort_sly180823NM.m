...
load('C:\work\ToSort_sly\SLy-180823_b2_AL\rez.mat');
...
save_strf=['C:\work\ToSort_sly\SLy-180823_b2_AL\STRF\Block-' num2str(block) '\xpz2\'];
...
load('C:\work\ToSort_sly\SLy-180823_b2_A1\rez.mat');
spikes=rez_nomerge.st3;
index_clusters=unique(spikes(:,4));
...
save_strf=['C:\work\ToSort_sly\SLy-180823_b2_A1\STRF\Block-' num2str(block) '\xpz5\'];
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Ch' num2str(cluster_number)],'-djpeg');
