...
for chi=1:128
    ...
    [Data] = readtank_sdk_v2('Z:\Tanks\SAM-190103',3,chi,'XPZ2');  
...
save_strf=['C:\work\STRF_tdt\SAM-190103\Block-' num2str(block) '\xpz2\'];
...
for chi=1:64
    ...
    [Data] = readtank_sdk_v2('Z:\Tanks\SAM-190103',3,chi,'XPZ5');  
    TrigTimes=round(Data.Fs*Data.Trig);
    [TrigA,TrigB]=trigfixstrf2(TrigTimes',400,899);
    %error here
...
save_strf=['C:\work\STRF_tdt\SAM-190103\Block-' num2str(block) '\xpz5\'];
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Ch' num2str(conta)],'-djpeg');
