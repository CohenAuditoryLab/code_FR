...
path='D:\SpikeSortingPipeline\Tanks\SAM-190220\Block-1\SAM-190220_Block-1_xpz5_ch66.sev';
...
savepath='Z:\ToSort_Sam\SAM-190220_b1_AL\merged\STRF\';
s_bin=0.15;
cs=1;
%Getting spet from kilosort result

load('C:\work\ToSort_Sam\SAM-190220_b1_xpz5AL\merged\rez.mat');
...
save_strf='C:\work\ToSort_Sam\SAM-190220_b1_xpz5AL\merged\STRF\';
...
save(save_strf,'STRFDataxpz5_AL');     
%%
%%%%%%%%%%%
load('C:\work\ToSort_Sam\SAM-190220_b1_xpz2ML\merged\rez.mat');
spikes=rez_merged.st3;
index_clusters=unique(spikes(:,5));
conta=1;
for s=1:length(index_clusters) 
...
save_strf='C:\work\ToSort_Sam\SAM-190220_b1_xpz2ML\merged\STRF\';
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
...
save(save_strf,'STRFDataxpz2_ml');     
%%

%%%%%%%%%%%A1
load('C:\work\ToSort_Sam\SAM-190220_b1_xpz2A1\merged\rez.mat');
spikes=rez_merged.st3;
index_clusters=unique(spikes(:,5));
conta=1;
for s=1:length(index_clusters) 
...
STRFDataxpz2_A1(conta) = struct('cluster',cluster_number,'No1',No1,'Wo1',Wo1,'No2',No2,'Wo2',Wo2,'STRF1',STRF1,'STRF2',STRF2,'taxis',taxis,'faxis',faxis,'PP',PP,'SPLN',SPLN,'Xa',Xa,'Ya',Ya,'Na',Na,'Xb',Xb,'Yb',Yb,'Nb',Nb);
figure;
taxis = (taxis)*1e3;
faxis = (faxis)*1e3;
%subplot(2,1,1)
...
save_strf='C:\work\ToSort_Sam\SAM-190220_b1_xpz2A1\merged\STRF\';
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Ch' num2str(cluster_number)],'-djpeg');
...
save(save_strf,'STRFDataxpz2_A1');     
