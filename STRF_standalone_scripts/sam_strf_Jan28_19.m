...
for chi=1:128
    ...
    [Data] = readtank_sdk_new2('D:\SpikeSortingPipeline\Tanks\SAM-190128',2,chi,'XPZ2');  
...
save_strf=['C:\work\STRF_tdt\SAM-190128\Block-' num2str(block) '\xpz2\'];
...
for chi=1:64
    ...
    [Data] = readtank_sdk_new('D:\SpikeSortingPipeline\Tanks\SAM-190128',2,chi,'XPZ5');  
    TrigTimes=round(Data.Fs*Data.Trig);
    [TrigA,TrigB]=trigfixstrf2(TrigTimes',400,899);
    %error here
...
save_strf=['C:\work\STRF_tdt\SAM-190128\Block-' num2str(block) '\xpz5\'];
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Ch' num2str(conta)],'-djpeg');
