...
path='D:\SpikeSortingPipeline\Tanks\SAM-190401\Block-2\SAM-190401_Block-2_xpz5_ch66.sev';
...
savepath='C:\work\ToSort_Sam\SAM-190401_b2_xpz5AL\STRF\';
s_bin=0.15;
cs=1;
%Getting spet from kilosort result
%%
load('C:\work\ToSort_Sam\SAM-190401_b2_xpz5AL\rez2.mat'); %need to see rez2 probably the same
s_bin=0.15;
cs=1;
spikes=rez.st3;
...
save_strf='C:\work\ToSort_Sam\SAM-190401_b2_xpz5AL\STRF\';
...
sprfile='C:\work\STRF\Moving_ripple\DMR_50HZ\DNR_Cortex_96k5min_4_50.spr';
load('C:\work\ToSort_Sam\SAM-190401_b2_xpz2A1\rez2.mat');
spikes=rez.st3;
%for ks2 cluster is at column 2
index_clusters=unique(spikes(:,2));
%index_clusters=unique(spikes(:,5));
...
save_strf='C:\work\ToSort_Sam\SAM-190401_b2_xpz2A1\STRF\';
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
...
%load('D:\SpikeSortingPipeline\Tanks\SAM-190325\SAM-190325-Triggers_block1_STRF.mat')
sprfile='C:\work\STRF\Moving_ripple\DMR_50HZ\DNR_Cortex_96k5min_4_50.spr';
load('C:\work\ToSort_Sam\SAM-190401_b2_xpz2ML\rez2.mat');
spikes=rez.st3;
%for ks2 cluster is at column 2
index_clusters=unique(spikes(:,2));
%index_clusters=unique(spikes(:,5));
...
save_strf='C:\work\ToSort_Sam\SAM-190401_b2_xpz2ML\STRF\';
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Ch' num2str(cluster_number)],'-djpeg');
