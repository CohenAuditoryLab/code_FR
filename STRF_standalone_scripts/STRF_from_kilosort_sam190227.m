...
path='D:\SpikeSortingPipeline\Tanks\SAM-190227\Block-2\SAM-190306_Block-2_xpz5_ch66.sev';
...
savepath='C:\work\ToSort_Sam\SAM-190306_b2_xpz5AL\STRF\';
s_bin=0.15;
cs=1;
...
%%
%%%%%%%%%%%
load('C:\work\ToSort_Sam\SAM-190306_b2_xpz2A1\STRF\'\rez.mat');
spikes=rez_merged.st3;
index_clusters=unique(spikes(:,5));
conta=1;
for s=1:length(index_clusters) 
