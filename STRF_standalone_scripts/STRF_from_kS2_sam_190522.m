...
myKsDir='C:\work\ToSort_Sam\SAM-190523_b1_xpz5AL';
sp = loadKSdir(myKsDir);

paramfile='C:\work\STRF\Moving_ripple\DMR_50HZ\DNR_Cortex_96k5min_4_50_param.mat';
path='D:\SpikeSortingPipeline\Tanks\SAM-190523\Block-1\SAM-190523_Block-1_xpz5_ch66.sev';
[TrigA,TrigB]=getting_triggers(path);
save('Z:\Francisco\Triggers\SAM-190523_b1_triggers.mat ','TrigA','TrigB');
warning('off','MATLAB:interp1:UsePCHIP')
sprfile='C:\work\STRF\Moving_ripple\DMR_50HZ\DNR_Cortex_96k5min_4_50.spr';
%savepath='H:\DataTanks\SAM-180417\Block-1\';
savepath='C:\work\ToSort_Sam\SAM-190523_b1_xpz5AL\STRFnp\';
s_bin=0.15;
cs=1;
...
save_strf='C:\work\ToSort_Sam\SAM-190523_b1_xpz5AL\STRFnp\';
...
%myKsDir='Z:\Francisco\ToSort_Sly\SLy-180823_b2_AL';
myKsDir='C:\work\ToSort_Sam\SAM-190523_b1_xpz2A1';
sp = loadKSdir(myKsDir);
...
sprfile='C:\work\STRF\Moving_ripple\DMR_50HZ\DNR_Cortex_96k5min_4_50.spr';
%savepath='H:\DataTanks\SAM-180417\Block-1\';
savepath='C:\work\ToSort_Sam\SAM-190523_b1_xpz2A1\STRFnp\';
s_bin=0.15;
cs=1;
%Getting spet from kilosort result
...
save_strf='C:\work\ToSort_Sam\SAM-190523_b1_xpz2A1\STRFnp\';
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Cluster' num2str(cluster_number)],'-djpeg');
