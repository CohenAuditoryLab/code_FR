...
savepath='Z:\ToSort_Sly\SLy-180823_b2_AL\merged\STRF\';
s_bin=0.15;
cs=1;
...
save_strf='Z:\ToSort_Sly\SLy-180823_b2_AL\merged\STRF\';
...
%%%%%%%%%%%
load('Z:\ToSort_Sly\SLy-180823_b2_A1\merged\rez.mat');
spikes=rez_merged.st3;
index_clusters=unique(spikes(:,5));
conta=1;
for s=1:length(index_clusters) 
