...
myKsDir='C:\work\ToSort_Sam\SAM-190521_b2_xpz5AL';
...
savepath='C:\work\ToSort_Sam\SAM-190521_b2_xpz5AL\STRFnp\';
s_bin=0.15;
cs=1;
...
save_strf='C:\work\ToSort_Sam\SAM-190521_b2_xpz5AL\STRFnp\';
...
%myKsDir='Z:\Francisco\ToSort_Sly\SLy-180823_b2_AL';
myKsDir='C:\work\ToSort_Sam\SAM-190521_b2_xpz2A1';
sp = loadKSdir(myKsDir);
...
sprfile='C:\work\STRF\Moving_ripple\DMR_50HZ\DNR_Cortex_96k5min_4_50.spr';
%savepath='H:\DataTanks\SAM-180417\Block-1\';
savepath='C:\work\ToSort_Sam\SAM-190521_b2_xpz2A1\STRFnp\';
s_bin=0.15;
cs=1;
%Getting spet from kilosort result
...
save_strf='C:\work\ToSort_Sam\SAM-190521_b2_xpz2A1\STRFnp\';
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Cluster' num2str(cluster_number)],'-djpeg');
