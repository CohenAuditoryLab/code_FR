...
% for chi=1:128
%        
%     [Data] = readtank_sdk_v2('Z:\DataTanks\SAM-181221',5,chi,'XPZ2');  
...
% %colormap jet;set(gca,'YDir','normal'); shading flat;colormap jet;
% 
% save_strf=['C:\work\STRF_tdt\SAM-181221\Block-' num2str(block) '\xpz2\'];
...
for chi=1:64
    ...
    [Data] = readtank_sdk_v2('Z:\DataTanks\SAM-181221',5,chi,'XPZ5');  
    TrigTimes=round(Data.Fs*Data.Trig);
    [TrigA,TrigB]=trigfixstrf2(TrigTimes',400,899);
    %error here
...
save_strf=['C:\work\STRF_tdt\SAM-181221\Block-' num2str(block) '\xpz5\'];
if ~exist(save_strf,'dir')
    mkdir(save_strf)
end
print([save_strf 'STRF_Ch' num2str(conta)],'-djpeg');
