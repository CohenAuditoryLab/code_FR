function [folder_pathd]=pre_process_data(sevpath,block,fdest,method,pre_amp,nChan,ax_area)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%         pre_amp='xpz5';
%         ax_area='AL';
%         pre_process_data(sevpath,block,fdest,method,pre_amp,nChan,ax_area);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
fs=24414.0625;
%Notch 60Hz IIR
